...
import com.boca.iot.platform.mapper.SysUserMapper;
import com.boca.iot.platform.model.dto.system.AssginRoleDto;
import com.boca.iot.platform.model.dto.system.LoginDto;
...
import com.boca.iot.platform.model.vo.system.LoginVo;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public LoginVo login(LoginDto loginDto) {
        ...
        if (StrUtil.isEmpty(redisCode) || !StrUtil.equalsIgnoreCase(redisCode, captcha)) {
            throw new DialingException(ResultCodeEnum.VALIDATECODE_ERROR);
        }
        // 验证通过 删除Redis中的验证码
...
//            throw new RuntimeException("用户名不存在") ;
            throw new DialingException(ResultCodeEnum.LOGIN_ERROR);
        }
        // 验证密码是否正确
...
//            throw new RuntimeException("用户名或者密码错误") ;
    ...
    public void saveSysUser(SysUser sysUser) {
        ...
        if(dbSysUser != null) {
            throw new DialingException(ResultCodeEnum.USER_NAME_IS_EXISTS) ;
        }
